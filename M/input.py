...
class Input:
    ...
    project = "M"  # a directory of this name is created, containing this input.py

    # Habitat:
    population = 1e4  # [people], can be a number or list of numbers
    ...
    tubeRadiusToRotRadius = 0.5  # for Tube and DumbbellTube
    oblateMinorToRotRadius = .5  # for Oblate
    torusHabToRotRadius = 0.25  # for Torus
    dumbbellMinorToRotRadius = 0.25  # for Dumbbell and DumbbellTube
